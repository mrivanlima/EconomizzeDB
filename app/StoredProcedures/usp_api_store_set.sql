...
BEGIN
    ...
    WHERE sanitized_cnpj = p_sanitized_cnpj
    RETURNING store_id
)
SELECT store_id INTO p_out_store_id FROM inserted_store;
		 ...
		 FROM app.store_json aj
		  ...
		  WHERE aj.sanitized_cnpj = p_sanitized_cnpj;
